...
local NB_BuildingRecipeList_Panel_Patch = {}

-- 按钮配置
NB_BuildingRecipeList_Panel_Patch.AButton = JoypadUtil.AButton
NB_BuildingRecipeList_Panel_Patch.BButton = JoypadUtil.BButton

function NB_BuildingRecipeList_Panel_Patch:apply(panel)
    if not panel then return end

    local _patch = NB_BuildingRecipeList_Panel_Patch
...
return NB_BuildingRecipeList_Panel_Patch
